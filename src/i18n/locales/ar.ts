...
const ar: Translation = {
  ...
  operator: {
    ...
    monthlyView: "التطور الشهري",
    allTransactions: "كل الحركات",
    expensesByCategory: "المصاريف حسب الفئة",
    yearSavings: "التوفير السنوي",
    forecasts: "التوقعات الشهرية",
    deadlines: "المواعيد",
    diary: "المذكرة الأولية",
    noDiary: "لا توجد مذكرة",
    balance: "الرصيد",
  ...
  notifications: {
    title: "الإشعارات",
    subtitle: "اختر كيف تريد استلام تذكيرات المواعيد",
    push: "إشعارات فورية على الهاتف",
    disablePush: "إيقاف الإشعارات الفورية",
    pushHint: "تصل حتى عندما يكون التطبيق مغلقًا. تتطلب إذن الجهاز.",
    email: "إشعارات عبر البريد الإلكتروني",
    emailHint: "في انتظار تفعيل نطاق البريد: يتم حفظ تفضيلك وسيبدأ الإرسال فور ربط النطاق.",
    emailAddress: "البريد الإلكتروني للتذكيرات",
    lead: "نبّهني مسبقًا",
    leadNow: "في الوقت المحدد",
    lead15: "قبل 15 دقيقة",
    lead60: "قبل ساعة",
    lead180: "قبل 3 ساعات",
    lead1440: "قبل يوم",
    ...
    denied: "تم رفض إذن الإشعارات من الجهاز",
    unsupported: "هذا المتصفح لا يدعم الإشعارات الفورية",
    iosHint: "على iPhone تعمل الإشعارات فقط إذا أضفت التطبيق إلى الشاشة الرئيسية وفتحته من هناك.",
    enabled: "الإشعارات الفورية مفعّلة",
    disabled: "الإشعارات الفورية معطّلة",
  },
  categories: {
    alimentari: "بقالة",
    bollette: "فواتير",
