...
const fr: Translation = {
  ...
  operator: {
    ...
    monthlyView: "Évolution mensuelle",
    allTransactions: "Tous les mouvements",
    expensesByCategory: "Dépenses par catégorie",
    yearSavings: "Épargne annuelle",
    forecasts: "Prévisions mensuelles",
    deadlines: "Échéances",
    diary: "Journal initial",
    noDiary: "Aucun journal rempli",
    balance: "Solde",
